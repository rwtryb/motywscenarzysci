...
*/
    ...
    ?>
		...
		<!-- tytul jezeli to projekt, sesja lub cokolwiek innego -->
		<?php if ( is_singular( 'projekt' ) ) {

			echo '<h1>'.get_field("tytuł_projektu").'</h1>';

		}  elseif ( is_singular( 'sesja' )) {

			echo '<h1>'.get_field("numer_sesji").'</h1>';
